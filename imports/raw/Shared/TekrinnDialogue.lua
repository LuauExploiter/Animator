-- Script Path: game:GetService("ReplicatedStorage").Resources.UFW.TekrinnDialogue
...
local function _(v5) --[[ Line: 54 ]] --[[ Name: easeOutQuad ]]
    return math.pow(v5 - 1, 3) * 2.70158 + 1 + math.pow(v5 - 1, 2) * 1.70158;
end;
...
local function v55(v18, v19) --[[ Line: 97 ]] --[[ Name: doText ]]
    -- upvalues: l_LocalPlayer_0 (copy), l_CollectionService_0 (copy), v17 (copy), l_TextService_0 (copy)
    v19 = v19 or l_LocalPlayer_0;
    local v20 = l_LocalPlayer_0.PlayerGui:FindFirstChild(v19.Name .. "KJUI") or script.KJDialogue:Clone();
    local v21 = "";
    local v22 = 0;
    local v23 = 0;
    local v24 = 0;
    if not v20:GetAttribute("Created") then
        ...
        l_Holder_0.Position = l_Holder_0.Position - UDim2.new(0, 0, 0, #l_CollectionService_0:GetTagged("KJUI") * 100);
        ...
        task.spawn(function() --[[ Line: 129 ]]
            -- upvalues: v20 (copy), v17 (ref), l_l_Template_0_0 (copy)
    ...
    for _, v40 in v18 do
        ...
        for _, v44 in v41 do
            ...
            task.delay(v24, function() --[[ Line: 221 ]]
                -- upvalues: v40 (copy), l_TextLabel_0 (copy), l_v23_0 (copy), l_v22_0 (copy), v20 (copy)
                local v50 = os.clock();
                repeat
                    ...
                    local v54 = 1 - (math.pow(v51 - 1, 3) * 2.70158 + 1 + math.pow(v51 - 1, 2) * 1.70158);
